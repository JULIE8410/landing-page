...
- Native browser [`constraint validation API`](https://developer.mozilla.org/en-US/docs/Web/HTML/Constraint_validation) 위에 구축

- 내장 유효성 검사를 지원

- 사용자 지정 유효성 검사를 지원

- 유효성 검사 메시지의 전체 사용자 지정

- 액세스 가능한 유효성 확인 메시지

- 클라이언트 측 및 서버 측 시나리오를 지원
